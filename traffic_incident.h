...
static const double time_Interval = 5.0;                                                 //时间间隔
...
static const double MaxLimitedSpeed = 45 / 3.6;
static const double MinLimitedSpeed = 10 / 3.6;
static const double ParkingSpeed = 2 / 3.6;
static const double NegativeSpeed = -5 / 3.6;
static const int    MaxLimitedVehicleNum = 10;
static const double MaxLimitedPresenceTime = 30;
static const double MaxLimitedAccidentTime = 30;
static const double Congestiondensity = 0.005;
static const double CongestionSpeed_Slight = 35 / 3.6;
static const double CongestionSpeed_Moderate = 30 / 3.6;
static const double CongestionSpeed_Severe = 20 / 3.6;
...
Vehicleincident_Detection Illegallanechange(Vehicleincident_Detection test, map<int, Vehicleincident_Detection> &II);
